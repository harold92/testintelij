    ...
    for (int i=0;i<conn.getAllEp().size()-1;i++) {
        if (conn.getAllEp().get(i).getNom().equals(conn.getAllEp().get(i+1).getNom())){
            for (int u=0;u<conn.getAllEp().get(i+1).getHeur().size();u++){
                conn.getAllEp().get(i).setDate(conn.getAllEp().get(i+1).getHeur().get(u).toString());
                conn.getAllEp().get(i).setHeur(conn.getAllEp().get(i+1).getDate().get(u).toString());
//                System.out.println(conn.getAllEp().get(i).getNom()+" "+conn.getAllEp().get(i).getDate().get(u)+" "
//                        +conn.getAllEp().get(i).getHeur()+" "+conn.getAllEp().get(i).getSall());
